 ...
 * Command: /mongoose-os/tools/mgos_gen_config.py --c_name=mgos_ro_vars --c_global_name=mgos_sys_ro_vars --dest_dir=/home/gustavosinbandera1/mongoose-os/apps/demo-c/build/gen/ /mongoose-os/src/mgos_ro_vars_schema.yaml
 */
