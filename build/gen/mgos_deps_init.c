...
extern bool mgos_Board_init(void);
extern bool mgos_Server_init(void);
...
static const struct lib_descr {
  ...
  bool (*init)(void);
    ...
    // "Board". deps: [ "core" "ethernet" "http-server" "i2c" "ota-http-client" "ota-http-server" "rpc-service-i2c" ]
    {.title = "Board", .init = mgos_Board_init},

    // "Server". deps: [ "core" "http-server" ]
    {.title = "Server", .init = mgos_Server_init},
